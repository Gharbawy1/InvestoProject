...
namespace Investo.DataAccess.Migrations.CoreEntites
{
    ...
    [Migration("20250505073742_AddedMaxProjectOfferAmounts")]
    partial class AddedMaxProjectOfferAmounts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Investo.Entities.Models.EmailVerificationToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EmailVerificationTokens", "CoreEntities");
                });
            ...
            modelBuilder.Entity("Investo.Entities.Models.Project", b =>
                {
                    ...
                    b.Property<decimal>("MaxOfferAmount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Investo.Entities.Models.EmailVerificationToken", b =>
                {
                    b.HasOne("Investo.Entities.Models.ApplicationUser", "User")
                        .WithMany()
