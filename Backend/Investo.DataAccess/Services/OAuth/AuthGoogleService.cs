...
namespace Investo.DataAccess.Services.OAuth
{
    public class AuthGoogleService : IAuthGoogleService
    {
        ...
        public AuthGoogleService(IOptions<GoogleAuthSettings> _googleOptions, UserManager<ApplicationUser> userManager, ITokenService tokenService
            , IConfiguration configuration, IImageLoadService imageLoadService, IEmailVerificationService emailverificationService)
        {
            _googleAuthSettings = _googleOptions.Value;
            ...
            try
            {
                ...
                if (user == null)
                {
                    ...
                    if (googleLoginDto.Role == "Investor")
                    {
                        ...
                        newUser = new Investor
                        {
                            ...
                            PersonInfo = new PersonInfo
                            {
                                ...
                                NationalIDImageFrontURL = await _imageLoadService.Upload(investorData.NationalIDImageFrontURL),
                                NationalIDImageBackURL = await _imageLoadService.Upload(investorData.NationalIDImageBackURL)
                            },
                    ...
                    else if (googleLoginDto.Role == "BusinessOwner")
                    {
                        ...
                        newUser = new BusinessOwner
                        {
                            ...
                            PersonInfo = new PersonInfo
                            {
                                ...
                                NationalIDImageFrontURL = await _imageLoadService.Upload(businessOwnerData.NationalIDImageFrontURL),
                                NationalIDImageBackURL = await _imageLoadService.Upload(businessOwnerData.NationalIDImageBackURL)
                            }
                        };
                    }
                    else // User
                    ...
                    return new OAuthLoginResponse
                    {
                        ...
                        profilePicture = newUser.ProfilePictureURL
                    };
                }
                else
                {
