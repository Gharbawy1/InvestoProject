...
namespace Investo.Presentation.Controllers
{
    ...
    public class ProjectController : ControllerBase
    {
        ...
        public ProjectController(IProjectService projectService, ICategoryService categoryService, IMapper mapper, IProjectRepository projectRepository, IOfferService offerService)
        {
        ...
        {
            var IsThisProjectHasAnyOffers = await _offerService.GetOffersByProjectId(id);
            if (IsThisProjectHasAnyOffers.Data.Any())
            {
                return BadRequest("This Project has related offers");
            }
            try
            {
